...
public class PersonDemoModel
{
	 ...
	 * @param page_links
	 */
	public PersonDemoModel(StringProperty name, StringProperty email, StringProperty pronouns, StringProperty phone,
